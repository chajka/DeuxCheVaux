...
struct Dwango_Nicolive_Chat_Data_Chat: Sendable {
  ...
  struct Modifier: Sendable {
    ...
    var color: Dwango_Nicolive_Chat_Data_Chat.Modifier.OneOf_Color? = nil
  ...
  fileprivate var _rawUserID: Int64? = nil
  fileprivate var _hashedUserID: String? = nil
  fileprivate var _modifier: Dwango_Nicolive_Chat_Data_Chat.Modifier? = nil
}
...
struct Dwango_Nicolive_Chat_Data_Jump: Sendable {
  ...
  fileprivate var _wait: SwiftProtobuf.Google_Protobuf_Duration? = nil
}
...
struct Dwango_Nicolive_Chat_Data_SimpleNotification: Sendable {
  ...
  var message: Dwango_Nicolive_Chat_Data_SimpleNotification.OneOf_Message? = nil
...
struct Dwango_Nicolive_Chat_Data_Gift: Sendable {
  ...
  fileprivate var _advertiserUserID: Int64? = nil
  fileprivate var _contributionRank: Int32? = nil
}
...
struct Dwango_Nicolive_Chat_Data_Nicoad: Sendable {
  ...
  var versions: Dwango_Nicolive_Chat_Data_Nicoad.OneOf_Versions? = nil
  ...
  struct V0: Sendable {
    ...
    struct Ranking: Sendable {
      ...
      fileprivate var _message: String? = nil
      fileprivate var _userRank: Int32? = nil
    }

    init() {}

    fileprivate var _latest: Dwango_Nicolive_Chat_Data_Nicoad.V0.Latest? = nil
  }
...
struct Dwango_Nicolive_Chat_Data_Statistics: Sendable {
  ...
  fileprivate var _viewers: Int64? = nil
...
struct Dwango_Nicolive_Chat_Data_Marquee: Sendable {
  ...
  struct Display: Sendable {
    ...
    fileprivate var _operatorComment: Dwango_Nicolive_Chat_Data_OperatorComment? = nil
    fileprivate var _duration: SwiftProtobuf.Google_Protobuf_Duration? = nil
  }

  init() {}

  fileprivate var _display: Dwango_Nicolive_Chat_Data_Marquee.Display? = nil
}
...
struct Dwango_Nicolive_Chat_Data_Enquete: Sendable {
  ...
  struct Choice: Sendable {
    ...
    fileprivate var _perMille: Int32? = nil
  }
...
struct Dwango_Nicolive_Chat_Data_MoveOrder: Sendable {
  ...
  var to: Dwango_Nicolive_Chat_Data_MoveOrder.OneOf_To? = nil
...
fileprivate let _protobuf_package = "dwango.nicolive.chat.data"
