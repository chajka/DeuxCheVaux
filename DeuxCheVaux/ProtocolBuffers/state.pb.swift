...
extension Dwango_Nicolive_Chat_Data_NicoliveState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _statistics: Dwango_Nicolive_Chat_Data_Statistics? = nil
    var _enquete: Dwango_Nicolive_Chat_Data_Enquete? = nil
    var _moveOrder: Dwango_Nicolive_Chat_Data_MoveOrder? = nil
    var _marquee: Dwango_Nicolive_Chat_Data_Marquee? = nil
    var _commentLock: Dwango_Nicolive_Chat_Data_CommentLock? = nil
    var _commentMode: Dwango_Nicolive_Chat_Data_CommentMode? = nil
    var _trialPanel: Dwango_Nicolive_Chat_Data_TrialPanel? = nil
    var _programStatus: Dwango_Nicolive_Chat_Data_ProgramStatus? = nil
    var _moderationAnnouncement: Dwango_Nicolive_Chat_Data_Atoms_ModerationAnnouncement? = nil
