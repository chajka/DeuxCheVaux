...
struct Dwango_Nicolive_Chat_Service_Edge_ChunkedMessage: @unchecked Sendable {
  ...
  struct Meta: Sendable {
    ...
    fileprivate var _origin: Dwango_Nicolive_Chat_Data_NicoliveOrigin? = nil
  }
...
struct Dwango_Nicolive_Chat_Service_Edge_PackedSegment: Sendable {
  ...
  fileprivate var _next: Dwango_Nicolive_Chat_Service_Edge_PackedSegment.Next? = nil
  fileprivate var _snapshot: Dwango_Nicolive_Chat_Service_Edge_PackedSegment.StateSnapshot? = nil
}
...
struct Dwango_Nicolive_Chat_Service_Edge_ChunkedEntry: Sendable {
  ...
  var entry: Dwango_Nicolive_Chat_Service_Edge_ChunkedEntry.OneOf_Entry? = nil
...
struct Dwango_Nicolive_Chat_Service_Edge_BackwardSegment: Sendable {
  ...
  fileprivate var _until: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
  fileprivate var _segment: Dwango_Nicolive_Chat_Service_Edge_PackedSegment.Next? = nil
  fileprivate var _snapshot: Dwango_Nicolive_Chat_Service_Edge_PackedSegment.StateSnapshot? = nil
}

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "dwango.nicolive.chat.service.edge"
...
extension Dwango_Nicolive_Chat_Service_Edge_ChunkedMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _meta: Dwango_Nicolive_Chat_Service_Edge_ChunkedMessage.Meta? = nil
